...
async def _run_demo():
    ...
    print(f"  [OK] Generated {len(dnac_payloads)} DNAC events")
    print(f"  [OK] Generated {len(mist_payloads)} Mist events")
    print(f"  [OK] Generated {len(sdwan_payloads)} SD-WAN events")
    ...
    print(f"\n  [OK] Normalized {len(all_events)} events")
    ...
    print(f"  [OK] Generated {len(incidents)} incidents")
    ...
    print(f"  [OK] Stored {len(incidents)} incidents in API service")
    ...
    # List all incidents
    all_incidents = await incident_service.list_incidents()
    print(f"\n  GET /incidents")
    print(f"    -> {len(all_incidents)} incidents found")

    # Get active incidents
    active_incidents = await incident_service.get_active_incidents()
