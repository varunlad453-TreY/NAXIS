...
→ For the platform-wide view, browse **[docs/handoff docs/](docs/handoff%20docs/)** (28 sessions of detailed change logs)
...
- **Purpose**: Frontend structure, conventions, and onboarding guide
- **For**: New frontend developers, code reviewers
- **Content**:
  - Tech stack and directory layout
  - Navigation configuration
  - Page composition conventions
  - Styling and API conventions
